...
* Đảm bảo bạn đã [cấp quyền truy cập tệp tin cho Bottles](./prerequisities#cấp-quyền-truy-cập-tệp-tin-cho-bottles).
...
* Game đó có thể đang chạy không ổn định ở trên Linux. Bạn cần liện hệ với nhà phát triển (nếu được) để tối ưu hóa cho Linux.
    * Chúc bạn may mắn khi đa số các nhà phát triển game Nobihaza hiện tại đều đang không dùng Linux. Điều này sẽ có thể thay đổi trong tương lai, nhưng hiện tại thì nó vẫn còn rất ít.
...
* Xem lại [Điều kiện cơ bản#Chuyển vùng của Bottle thành Nhật Bản](./prerequisities#chuyển-vùng-của-bottle-thành-nhật-bản) và [Điều kiện cơ bản#Các thư viện cần thiết](./prerequisities#các-thư-viện-cần-thiết).
...
* Xem lại [Điều kiện cơ bản#Chuyển vùng của Bottles thành Nhật Bản](./prerequisities#chuy%E1%BB%83n-v%C3%B9ng-c%E1%BB%A7a-bottle-th%C3%A0nh-nh%E1%BA%ADt-b%E1%BA%A3n).
...
* Nếu bạn chắc chắn lỗi này xảy ra không chỉ trên Linux, bạn bắt buộc phải liên hệ với nhà phát triển để sửa lỗi này.
