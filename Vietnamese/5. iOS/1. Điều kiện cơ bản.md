...
* Không yêu cầu máy tính:
    ...
    * [Sử dụng Scarlet](#sử-dụng-scarlet).
...
* Vào phần **Cài đặt** của ESign và chọn **Nhập Nguồn**. Chọn tệp `.ipa` mà bạn đã tải trước đó. Đối với EasyRPG bản tiếng Việt thì nó sẽ là `ios-arm64-retroarch.ipa`.
