...
> [!IMPORTANT]
> Đọc phần [Điều kiện cơ bản](1.%20Điều%20kiện%20cơ%20bản.md) trước khi tiếp tục đọc hướng dẫn này.
...
> [!IMPORTANT]
> **Đảm bảo là bạn đang di chuyển lối tắt** (ghi chữ Lối tắt/Alias ở cột Định dạng/Kind) chứ không phải di chuyển ứng dụng (ghi chữ Ứng dụng/Application thay vì Lối tắt/Alias). Di chuyển ứng dụng thay vì lối tắt có thể sẽ làm game không chạy được!
